    ...
    <div className="fixed top-0 left-0 right-0 md:left-64 h-14 sm:h-16 bg-white border-b border-gray-200 flex items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 z-30">
      ...
      <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
        ...
        <div className="flex items-baseline gap-2">
          <h1 className="text-xl sm:text-2xl font-bold text-primary-600 tracking-tight">Falcon</h1>
          <span className="text-sm text-gray-300 hidden sm:inline">|</span>
          <p className="text-sm text-gray-500 hidden sm:inline italic">Faculty Analytics & Learning Console</p>
        </div>
      </div>

      {/* Right side - Profile */}
      <div className="flex items-center gap-3">
        <p className="hidden sm:block text-sm font-medium text-gray-900">Dr. Rajesh Kumar</p>
